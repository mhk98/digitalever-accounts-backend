...
router.get("/", auth(), requireMenuPermission("employee_list"), EmployeeListController.getAllFromDB);
router.get(
  "/all",
  auth(),
  requireMenuPermission("employee_list"),
...
router.get("/:id", auth(), requireMenuPermission("employee_list"), EmployeeListController.getDataById);
router.delete(
  "/:id",
